...
namespace Login
{
    class Paragrafos
    {
        ...
        "mais frescas do dia, logo pela manhã ou no final da tarde/inicio da noite, visando minimizar "+
        "os potenciais danos.\n\n";
        }

        public string quartoParagrafo()
        {
            return "Esta tabela deverá receber os dados relativos à coluna Pragas/Doenças das culturas "+
                "escolhidas.\n\n";
        }
        ...
        {
            return "Transcrever a tabela de fertilizantes na totalidade, retirando as colunas relativas "+
                "aos nutrientes. Em todas as recomendações.\n\n";
        }

        public string segundoTitulo()
        {
            return "Recomendamos a leitura cuidadosa dessas recomendações iniciais, visando o máximo "+
                "aproveitamento com um mínimo de riscos.\n\n";
        }
        ...
        "exemplares, o que implica em perda do propósito inicial do projeto, de oferecer variedade "+ 
        "comqualidade o ano todo.\n"+
        ...
        "mangueira um “chuveirinho” e reduzir a pressão para melhorar a eficiência e o aproveitamento "+
        "da água.\n\n";
        }
    }
}
